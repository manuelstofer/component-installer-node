...
Package.prototype.reallyInstall = require('./patch-package').reallyInstall;
...
Installer.prototype.installPackage = function (name, version) {
  this.touch('node_modules');

  var pkg = new Package(name, version, {
    concurrency: this._concurrency,
    dest: this._destination || 'node_modules',
    dev: this._development,
    force: this._force,
    proxy: this._proxy,
    remotes: this._remotes.concat(['https://raw.github.com'])
  });
